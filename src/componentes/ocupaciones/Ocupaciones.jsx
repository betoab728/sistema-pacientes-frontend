...
const Ocupaciones = () => {
  ...
  return (
    <div className='mt-12'>
      <h1 className="text-2xl font-bold mb-2 text-center">Ocupaciones del sistema</h1>
          ...
          {jobs.map((ocupacion) => (
            <tr key={ocupacion._id}>
              ...
              <td className="py-2 px-4 border-b text-left">
                <button onClick={() => handleModificar(ocupacion._id)} className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
